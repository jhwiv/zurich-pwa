...
const ITINERARY = {
  trip: {
    ...
    hotel: {
      ...
      lat: 47.3812,
      lng: 8.5387,
      homeStop: "Sihlquai/HB — 6 min walk",
  ...
  days: [
    {
      ...
      stops: [
        ...
        { time: "Charlotte", title: "Charlotte's Place · Amager", desc: "Charlotte's place while studying in Copenhagen. Holmbladsgade 70B, 2300 København S. Amagerbro neighborhood — 15 min from hotel by M2 metro to Amagerbro station then 6-min walk.", address: "Holmbladsgade 70B", tags: ["🚇 M2 → Amagerbro · 15 min"] },
    ...
    },
    {
      ...
      lng: 8.5417,
      stops: [
        { time: "7:40 PM", title: "Airport → Zürich Marriott Hotel", desc: "Collect bags. Activate Zürich Card in the app. Airport Express to HB every 10 min — 10-min ride. Tram 13 one stop to Sihlquai/HB. Hotel is 6 min walk. Arrive ~8:30–8:45 PM.", tags: ["🚆 Airport Express + Tram 13", "⏱ 30–40 min door-to-door"] },
      ...
      extras: "Short riverfront walk along the Limmat before bed — lit bridges at night, 3 min from hotel."
    },
    {
      id: "saturday",
      ...
      stops: [
        ...
        { time: "4:30 PM", title: "Old Town — Augustinergasse & Cathedrals", desc: "Zürich's most photographed medieval lane. Grossmünster (twin-towered cathedral, begun 1100s). Fraumünster with Marc Chagall's stained glass. Münsterhof square.", lat: 47.3700, lng: 8.5413, tags: ["🚶 10 min walk from Kunsthaus", "⛪ Both free entry", "⏱ Sat 10 AM–5 PM"] },
        ...
        { time: "7:30 PM", title: "Dinner: Zeughauskeller", desc: "Zürich's most famous beer-hall restaurant, in a 15th-century former armory on Bahnhofstrasse. Excellent Zürcher Geschnetzeltes. 🌿 Älplermagronen (Alpine macaroni). CONFIRMED reservation 7:30 PM.", address: "Bahnhofstrasse 28A", phone: "+41 44 220 15 15", confirmed: true, lat: 47.3699, lng: 8.5378, tags: ["🚶 2 min from Münsterhof", "💰 CHF 35–55 pp", "⏱ Reservation 7:30 PM"] }
      ],
    ...
    },
    {
      ...
      lng: 8.5417,
      stops: [
        { time: "10:00 AM", title: "Breakfast: Hiltl", desc: "World's oldest vegetarian restaurant (est. 1898). Sunday brunch buffet — 100+ dishes: Indian curries, Middle Eastern mezze, Swiss cheese boards, fresh pastries. CHF 57 pp all-inclusive.", address: "Sihlstrasse 28", lat: 47.3744, lng: 8.5370, tags: ["🚶 18 min from hotel", "🌿 All vegetarian", "⏱ Brunch 9:30 AM–2:30 PM"] },
        { time: "11:15 AM", title: "Lake Zürich Promenade", desc: "Quaianlagen park from Bürkliplatz: swans, sailboats, Alps views on clear days. Unscheduled downtime.", lat: 47.3657, lng: 8.5413, tags: ["🚶 13 min S from Hiltl", "🆓 Free"] },
  ...
  transit: [
    ...
    { dest: "Café Sprüngli", via: "Walk from HB or Tram 13 → Paradeplatz", time: "13/5 min" },
    { dest: "Kunsthaus", via: "Tram 3 Paradeplatz → Kunsthaus", time: "11 min" },
    { dest: "Old Town / Fraumünster", via: "Walk south via Grossmünster", time: "10 min" },
    { dest: "Zeughauskeller", via: "Walk 2 min N from Münsterhof", time: "2 min" },
